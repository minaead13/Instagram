...
class RegistrationViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        emailField.frame = CGRect(x: 20, y: passwordField.bottom+10, width: view.width-40, height: 52)
        registerButton.frame = CGRect(x: 20, y: emailField.bottom+10, width: view.width-40, height: 52)
    }
