...
final class ProfileInfoHeaderCollectionReusableView: UICollectionReusableView {
    ...
    override func layoutSubviews() {
        ...
        let countButton = (width-10-profilePhotoSize)/3
        
        postButton.frame = CGRect(x: profilePhotoImageView.right, y: 5, width: countButton, height: buttonHeight).integral
        followersButton.frame = CGRect(x: postButton.right, y: 5, width: countButton, height: buttonHeight).integral
        followingButton.frame = CGRect(x: followersButton.right, y: 5, width: countButton, height: buttonHeight).integral
        editProfileButton.frame = CGRect(x: profilePhotoImageView.right, y: 5+buttonHeight, width: countButton*3, height: buttonHeight).integral
